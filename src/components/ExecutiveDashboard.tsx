        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/80">
              ...
              <div className="text-lg font-bold text-slate-900 font-mono mt-0.5">{kpis.receivablesMetrics.totalOverdueInvoices}</div>
              <div className="text-[11px] text-slate-500">total invoices</div>
            </div>
            <div className="p-3 rounded-xl bg-emerald-50/60 border border-emerald-200/80">
              <div className="text-[10px] text-emerald-600 uppercase tracking-wider font-semibold">Recovered</div>
              <div className="text-lg font-bold text-emerald-700 font-mono mt-0.5">{kpis.receivablesMetrics.totalRecoveredInvoices}</div>
              <div className="text-[11px] text-emerald-600">invoices settled</div>
            </div>
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/80">
              <div className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">Recovery Rate</div>
              <div className="text-lg font-bold text-indigo-600 font-mono mt-0.5">{kpis.receivablesMetrics.receivablesRecoveryRatePct}%</div>
            ...
            <div className="p-3 rounded-xl bg-emerald-50/60 border border-emerald-200/80">
              ...
              <div className="text-lg font-bold text-emerald-700 font-mono mt-0.5">₹{kpis.receivablesMetrics.totalRecoveredINR.toLocaleString('en-IN')}</div>
              <div className="text-[11px] text-emerald-600">of ₹{kpis.receivablesMetrics.totalOutstandingINR.toLocaleString('en-IN')}</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-2">
                {kpis.receivablesMetrics.agingBreakdown.map((bucket, idx) => (
                  <div key={idx} className="p-2.5 rounded-lg bg-slate-50/80 border border-slate-200/70">
                    <div className="flex items-center justify-between text-xs mb-1">
            ...
            <div>
              ...
              <div className="space-y-2">
                {kpis.receivablesMetrics.rootCauseBreakdown.map((cause, idx) => (
                  <div key={idx} className="p-2.5 rounded-lg bg-slate-50/80 border border-slate-200/70 flex items-center justify-between">
                    <div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/80">
              ...
              <div className="text-lg font-bold text-slate-900 font-mono mt-0.5">{kpis.voiceMetrics.totalCallsPlaced}</div>
            ...
            <div className="p-3 rounded-xl bg-violet-50/60 border border-violet-200/80">
              ...
              <div className="text-lg font-bold text-violet-700 font-mono mt-0.5">{kpis.voiceMetrics.callSuccessRatePct}%</div>
            ...
            <div className="p-3 rounded-xl bg-emerald-50/60 border border-emerald-200/80">
              ...
              <div className="text-lg font-bold text-emerald-700 font-mono mt-0.5">{kpis.voiceMetrics.promiseToPayConversionRatePct}%</div>
            ...
            <div className="p-3 rounded-xl bg-emerald-50/60 border border-emerald-200/80">
              ...
              <div className="text-lg font-bold text-emerald-700 font-mono mt-0.5">₹{kpis.voiceMetrics.revenueRecoveredViaVoiceINR.toLocaleString('en-IN')}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-2">
                {kpis.voiceMetrics.outcomeBreakdown.map((item, idx) => (
                  <div key={idx} className="p-2.5 rounded-lg bg-slate-50/80 border border-slate-200/70">
                    <div className="flex items-center justify-between text-xs mb-1">
            ...
            <div>
              ...
              <div className="space-y-2">
                {kpis.voiceMetrics.languageBreakdown.map((lang, idx) => (
                  <div key={idx} className="p-2.5 rounded-lg bg-slate-50/80 border border-slate-200/70 flex items-center justify-between">
                    <div>
              ...
              <div className="mt-3 p-2.5 rounded-lg bg-violet-50/50 border border-violet-200/50">
                <div className="flex items-center justify-between text-[11px]">
                  ...
                  <span className="font-mono font-bold text-violet-800">{kpis.voiceMetrics.avgCallDurationSeconds}s</span>
                </div>
                <div className="flex items-center justify-between text-[11px] mt-1">
                  <span className="text-violet-700 font-semibold">Cost per Recovery</span>
                  <span className="font-mono font-bold text-violet-800">₹{kpis.voiceMetrics.costPerRecoveryINR}</span>
                </div>
                <div className="flex items-center justify-between text-[11px] mt-1">
                  <span className="text-violet-700 font-semibold">First Attempt Success</span>
                  <span className="font-mono font-bold text-violet-800">{kpis.voiceMetrics.retryStats.firstAttemptSuccessPct}%</span>
                </div>
              </div>
            </div>
          </div>
